...
public:
    ...
    static boost::shared_ptr<Leader> getLeader(enum Strategy strategy, uint8_t **leaderResults, uint32_t *binIds, const boost::shared_ptr<uint32_t> &perm, uint32_t numOfBins,
