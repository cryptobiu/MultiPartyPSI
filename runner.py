...
'''
'''
strategies = [Strategy.NAIVE_METHOD_SMALL_N,Strategy.NAIVE_METHOD_LARGE_N,Strategy.SIMPLE_HASH,Strategy.GAUSS_SIMPLE_HASH,
              Strategy.BLOOM_FILTER,Strategy.POLYNOMIALS,Strategy.POLYNOMIALS_SIMPLE_HASH]
'''
strategies = [Strategy.SIMPLE_HASH]
